...
import { BadgeIndianRupee, Dot, EyeClosed, Search, Star, Trash2, Users } from 'lucide-react';
  ...
  return (
    <div className={doctorListStyles.container}>
        ...
        <div className={doctorListStyles.headerTopSection}>
          ...
          <div className={doctorListStyles.headerSearchContainer}>
            <div className={doctorListStyles.searchBox}>
              ...
              <input value={query} onChange={(e)=> setQuery(e.target.value)} placeholder='Search Doctors by specialization or name' className={doctorListStyles.searchInput} />
            </div>
      ...
      <main className={doctorListStyles.gridContainer}>
        ...
        {filtered.length > 6 && (
          <div className={doctorListStyles.showMoreButton}>
