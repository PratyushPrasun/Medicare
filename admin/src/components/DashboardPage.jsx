...
import { BadgeIndianRupee, Calendar, CheckCircle, Search, User, UserRoundCheck, XCircle } from 'lucide-react';
    ...
    <div className={s.pageContainer}>
        <div className={s.maxWidthContainer}>
            ...
            <div className={s.statsGrid}>
                <StatCard icon={<User className='w-6 h-6'/>}
                ...
                <StatCard icon={<Calendar className='w-6 h-6'/>}
                ...
                label = "Checked" value={totals.completed}/>
                <StatCard icon={<XCircle className='w-6 h-6'/>}
                label = "Checked" value={totals.canceled}/>
            ...
            <div className="mb-6">
                ...
                <div className={s.searchContainer}>
                    <div className={s.searchInputContainer}>
                        ...
                        placeholder='Search name/ Speciatization /Fee'/>
                        <Search className={s.searchIcon}/>
                    </div>
                    <button className={s.clearButton + "" + s.cursorPointer}
                    onClick={()=>{
                        setQuery(" ");
                        showAll(false)
                    }}>
            ...
            <div className={s.tableContainer}>
                ...
                {filteredDoctors.length > INITIAL_COUNT && (
                    <div className={s.showMoreContainer}>
                        <button onClick={()=>
                            setShowAll((s)=> !s)}>
                                {showAll?"Showless":`Show more(${filteredDoctors.length - INITIAL_COUNT})`}
                            </button>
                    </div>
                )}
            </div>
