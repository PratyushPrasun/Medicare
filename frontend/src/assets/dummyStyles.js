...
export const bannerStyles = {
  ...
  bannerContainer: "relative w-full max-w-7xl mx-auto my-1 px-4",
  ...
  outerAnimatedBand: "absolute inset-0 rounded-3xl bg-linear-to-r from-green-400 via-emerald-500 to-green-400  opacity-80",
  ...
  title: "text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold text-gray-800 mb-1",
...
export const navbarStyles = {
  ...
  navItem: "nav-item px-5 md:px-4 py-2.5 rounded-full text-md font-semibold transition-all duration-300",
  navItemActive: "active text-emerald-600",
